...
class Map:
    ...
    def get_tracer(self,person_location,radius_km):
        ...
        satellites_start = self.satellites_start # Начальные координаты спутников
        satellites_end = self.satellites_end     # Конечные координаты спутников
        debris_start = self.debris_start         # Начальные координаты мусора
        debris_end = self.debris_end             # Конечные координаты мусора
